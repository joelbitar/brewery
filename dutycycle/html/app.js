...
dcApp.controller('DutyCycleController', function DutyCycleController($scope, $timeout) {
    ...
    $scope.relay_order = [1, 2, 3];

    function randomizeRelayOrder(){
        $scope.relay_order = _.shuffle($scope.relay_order);
    }
